...
Для получения аналитического отчета с программным кодом к данному заданию необходимо два основных файла сохранить в едином проекте:
1) локально сохраненный файл gender_recognizer.py, 
